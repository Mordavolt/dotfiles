...
if (xrandr | grep "$EXT"); then
    ...
    xrandr --output eDP-1-1 --mode 1920x1080 --pos 0x902 --rotate normal --output DP-1-1 --off --output DP-1-2 --off --output DP-1-3 --mode 1920x1080 --pos 1920x0 --rotate normal
else
